...
config_email = config['LINKEDIN']['email']
config_password = config['LINKEDIN']['pass']
...
scrape_jobs( login_and_search(emailaddress = config_email, passwordkey = config_password) )
